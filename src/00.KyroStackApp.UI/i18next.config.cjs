/** @file see https://github.com/i18next/i18next-parser?tab=readme-ov-file#options */
...
const config = {
	...
	defaultValue: (_locale, _ns, key) => key ?? 'MISSING_TRANSLATIONS',
	...
	output: 'src/localization/translations/$LOCALE.json',
