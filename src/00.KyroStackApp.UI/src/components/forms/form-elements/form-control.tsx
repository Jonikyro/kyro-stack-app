...
export function FormControl({ as, className, ...rest }: FormControlProps) {
	...
	return (
		<As
			className={cn(
				'flex cursor-text overflow-hidden whitespace-nowrap rounded border border-solid border-outline bg-surface-container-highest text-on-surface focus-within:border-primary',
				className
			)}
